...
import { ColorPallete } from '../_colors'
      ...
      >
        <Box display='flex' flexDirection='column' gap='4px'>
          ...
          <Typography variant='bodyMedium'>
            This system uses MUI&apos;s foundation, so it&apos;s easy to scale
            and works great for keeping things consistent. You get a full set of
